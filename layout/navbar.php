        ...
        <div class="flex flex-wrap justify-between items-center ">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Report <span class="text-gray-300 font-bold">Systems</span></span>
                </a>

                <!-- Tab Name -->
                <h4 class="hidden lg:block lg:text-2xl font-bold text-primary ml-5 text-white "><?= ucwords($_GET['page']) ?></h4>
            ...
            <div class="flex items-center gap-3 lg:order-2">
                ...
                ?>
                    <a href="index.php?page=create" type="button" class="group inline-flex items-center px-4 py-2 text-sm font-medium text-blue-400 bg-transparent border border-blue-300 rounded hover:bg-blue-500 hover:text-white focus:z-10 focus:ring-2 ">
                        <svg class="w-4 h-4 mr-2 text-blue-600 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown" class="flex items-center justify-center relative w-9 h-9 rounded-xl text-gray-600 bg-blue-200 hover:bg-acent1 hover:text-white focus:bg-acent1 focus:text-white transition-all duration-200">
                    <span class="absolute flex h-5 w-6 -top-2 -right-3">
                        ...
                        <span class="relative flex items-center justify-center rounded-full h-6 w-6 bg-blue-500 text-[9px] text-white">02</span>
                    </span>
                ...
                <!-- User Profile -->
                <button type="button" class="flex mx-3 text-sm bg-black rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-blue-200" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                    <span class="sr-only">Open user menu</span>
                    <img class="w-8 h-8 rounded-full object-cover" src="../assets/images/profile.png" alt="user photo" />
                </button>
                <!-- Dropdown menu -->
