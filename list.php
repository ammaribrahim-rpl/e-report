...
<div class="relative overflow-x-auto sm:rounded-lg mt-10">
    <table class="w-full text-sm text-left rtl:text-right text-gray-900" id="pagination-table">
                            ...
                            <td class="px-6 py-4 flex justify-start items-center ">
                                <?php if ($report['status'] == 0) : ?>
                                    <a href="#" onclick="confirmApprove('reports_approve', 'id', <?= $report['id'] ?>)" class="font-medium text-white hover:underline">
                                        <svg class="mr-4 w-4 h-4 md:w-5 md:h-5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <a href="index.php?page=detail&id=<?= $report['id'] ?>" class="font-medium text-white hover:underline">
                                    <svg class="mr-4 w-4 h-4 md:w-5 md:h-5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
